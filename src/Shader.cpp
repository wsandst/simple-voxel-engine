...
{
	std::string vertexPath = "shaders/" + path + ".vert";
	std::string fragmentPath = "shaders/" + path + ".frag";
	std::string vertexCode = FileHandler::loadStrFile(vertexPath.data());
	std::string fragmentCode = FileHandler::loadStrFile(fragmentPath.data());
